...
public class ApplicantDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (selectedApplicant != null) {
            editTextFullName.setText(selectedApplicant.getFullName());
            editTextPhoneNumber.setText(selectedApplicant.getPhoneNumber());
            editTextEgeScore.setText(String.valueOf(selectedApplicant.getEgeScore()));
        ...
        btnSaveChanges.setOnClickListener(v -> {
            ...
            selectedApplicant.setFullName(fullName);
            selectedApplicant.setPhoneNumber(phoneNumber);
            selectedApplicant.setEgeScore(egeScore);
            ...
            editTextFullName.setText(applicant.getFullName());
            ...
            editTextEgeScore.setText(String.valueOf(applicant.getEgeScore()));
